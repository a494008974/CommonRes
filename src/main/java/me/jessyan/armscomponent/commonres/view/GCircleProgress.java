...
public class GCircleProgress extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.public_GCircleProgress, defStyle, 0);

        mBackgroundColor = a.getColor(R.styleable.public_GCircleProgress_public_circle_background,mBackgroundColor);
        mProgressBackgroundColor = a.getColor(R.styleable.public_GCircleProgress_public_circle_progressBackground,mProgressBackgroundColor);
        mProgressColor = a.getColor(R.styleable.public_GCircleProgress_public_circle_progressColor,mProgressColor);
        mTextColor = a.getColor(R.styleable.public_GCircleProgress_public_circle_textColor,mTextColor);
        mTextSize = a.getDimension(R.styleable.public_GCircleProgress_public_circle_textSize, mTextSize);
        mRoundSize = a.getFloat(R.styleable.public_GCircleProgress_public_circle_round_size, mRoundSize);

        setProgress(a.getInt(R.styleable.public_GCircleProgress_public_circle_progress_current, 0));
        setMax(a.getInt(R.styleable.public_GCircleProgress_public_circle_progress_max, 100));
