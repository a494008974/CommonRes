 ...
 */
public class GMarqueeTextView extends SurfaceView implements SurfaceHolder.Callback{

    public Context  mContext;

    private float mTextSize = 28; //字体大小
    ...
    public GMarqueeTextView(Context context) {
        this(context,null);
    }

    public GMarqueeTextView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GMarqueeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.public_GCircleProgress, defStyleAttr, 0);
        mTextColor = a.getColor(R.styleable.public_GMarqueeTextView_public_marquee_textcolor, Color.argb(90, 255, 255, 255));
        mTextSize = a.getDimension(R.styleable.public_GMarqueeTextView_public_marquee_textSize, 24);
        mBackgroundColor=a.getColor(R.styleable.public_GMarqueeTextView_public_marquee_marqueebackground,Color.BLACK);
        mIsRepeat=a.getBoolean(R.styleable.public_GMarqueeTextView_public_marquee_isRepeat,true);
        mStartPoint=a.getInt(R.styleable.public_GMarqueeTextView_public_marquee_startPoint,0);
        mDirection=a.getInt(R.styleable.public_GMarqueeTextView_public_marquee_direction,0);
        mSpeed=a.getInt(R.styleable.public_GMarqueeTextView_public_marquee_speed,20);
        a.recycle();
    ...
    public  void startScroll(){
    	 android.util.Log.d("TTTT", "startScroll === ==================" );
        if(mThread!=null&&mThread.isRun)
            return;
        
        android.util.Log.d("TTTT", "startScroll ===mThread ==================" );
                ...
                synchronized (holder) {
                    ...
                    if(canvas != null){
                    	canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
                    	 ...
                    	 android.util.Log.d("TTTT", "canvas is null === ==================" );
                    }
